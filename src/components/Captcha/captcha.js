                  ...
                  arguments.length > 1 &&
                    ...
                    o !== o
                      ...
                      : 0 !== o &&
                        ...
                        (o = (o > 0 || -1) * Math.floor(Math.abs(o))));
                  for (
                    var i = o >= 0 ? Math.min(o, n - 1) : n - Math.abs(o);
                    i >= 0;
                    i--
                  )
                    if (i in t && t[i] === e) return i;
                ...
                (NoCaptcha.prototype = {
                  init: function (e) {
                    ...
                    (this.render_to = opt.renderTo),
                      ...
                      opt.is_tbLogin &&
                        (tb_login =
                          __webpack_require__(117).makeTBLogin(inn_vars)),
